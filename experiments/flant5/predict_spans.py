...
def predict_generation(dp, model, tokenizer, nbeams, max_input_len, max_decode_len):
    ...
    elif "generation_seed_ids" in dp:
        decoder_input_ids = torch.tensor([[0]+dp["generation_seed_ids"]]).cuda()
